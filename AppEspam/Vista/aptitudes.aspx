<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="aptitudes.aspx.cs" Inherits="Vista.aptitudes" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title>Examen de Aptitudes</title>
                            ...
                            <div class="col-lg-12">
								...
								<div class="portlet portlet-default">
                                    ...
                                    <div class="portlet-body">
                                        <h4>Escoger de la lista las opciones correctas</h4>
                                        <input type="text" class="form-control" id="tokenfield-autocomplete" value="red,green,blue" placeholder="Selecciona una" />
                                    </div>
                                ...
                                <div class="portlet portlet-default">
                                    ...
                                    <div class="portlet-body">
                                        <h4>Eliminar la palabra que no se relaciona a la computacion</h4>
                                        <input type="text" class="form-control" id="tokenfield-typeahead" value="computadora,internet,servidor,gato,sistema"/>
                                    </div>
                                </div>
                                <!-- /.portlet -->
                                        ...
                                        <div class="portlet-body">
                                            <form class="form-horizontal">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label">Seleccion Multiple</label>
                                                    <div class="col-sm-10">
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" value="">Opcion 1
                                                            </label>
                                                        </div>
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" value="">Opcion 2
                                                            </label>
                                                        </div>
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" value="">Opcion 3
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label">Seleccione una respuesta</label>
                                                    <div class="col-sm-10">
                                                        <div class="radio">
                                                            <label>
                                                                <input type="radio" name="optionsRadios" id="optionsRadios1" value="" checked>Opcion 1
                                                            </label>
                                                        </div>
                                                        <div class="radio">
                                                            <label>
                                                                <input type="radio" name="optionsRadios" id="optionsRadios2" value="">Opcion 2
                                                            </label>
                                                        </div>
                                                        <div class="radio">
                                                            <label>
                                                                <input type="radio" name="optionsRadios" id="optionsRadios3" value="" >Opcion 3
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label">Seleccione de la lista</label>
                                                    <div class="col-sm-10">
