...
!function ($) {
    ...
    $.fn.confirmation.defaults = $.extend({}, $.fn.tooltip.defaults, {
		...
		, template: '<div class="popover" >' +
                ...
                //'<input type="text" name="Id" id="Id" value="" class="hide">' +
				'<div id="botones" class="btn-group">' +
				'<a name="ok" id="ok" class="btn btn-xs" target="" runat="server"></a>' +
				'<a class="btn btn-xs" data-dismiss="confirmation"></a>' +
				'</div>' +
				'</div>'
		, btnOkClass: 'btn-primary'
		, btnCancelClass: 'btn-danger'
		, btnOkLabel: '<i class="fa fa-check-circle icon-white"></i> Si'
